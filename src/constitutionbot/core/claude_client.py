...
New code should use the LLM abstraction from `constitutionbot.core.llm`.

Example:
    # Old way (still works)
    from constitutionbot.core.claude_client import get_claude_client
    client = get_claude_client()
    response = client.generate("prompt")

    # New way (recommended)
    from constitutionbot.core.llm import get_llm_provider_sync
...
from constitutionbot.core.llm import LLMProvider, get_llm_provider_sync
...
def get_claude_client() -> ClaudeClient:
    ...
    DEPRECATED: Use `get_llm_provider_sync()` from `constitutionbot.core.llm` instead.
    """
