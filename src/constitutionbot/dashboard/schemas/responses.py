...
class ConstitutionSectionResponse(BaseModel):
    """Constitution section response."""
...
class ConstitutionUploadResponse(BaseModel):
    """Response after uploading Constitution."""
...
class ConstitutionSummaryResponse(BaseModel):
    """Summary of loaded Constitution."""
